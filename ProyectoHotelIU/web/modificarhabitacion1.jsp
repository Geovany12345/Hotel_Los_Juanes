<%-- 
    Document   : modificarhabitacion1
    Created on : 30-nov-2020, 16:52:44
    Author     : Yutokiva
--%>
...
<html>
   <head>
	...
	java.lang.String result = port.obtenerHabitaciones();
...
out.print(resultfinal);
  ...
  <li class="nav-item">
                            ...
                            <button onclick="location.href='modificarhabitacion.jsp'">SIGUIENTE</button>
                        </li>
    </body>
</html>
